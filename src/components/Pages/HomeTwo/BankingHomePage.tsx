              ...
              <div className="section__content titlemain">
                <FadeLeft>
                  <div className={styles.titleWrapper}>
                    ...
                    <h1 className={styles.subTitle}>Find. Fit. Finance.</h1>
                  </div>
                </FadeLeft>
                
                <FadeRight>
                  <h1 className={styles.mainTitle}>Discover the loan that fits your life.</h1>
                </FadeRight>
...
const LoanCard: React.FC<LoanCardProps> = ({ title, iconSrc, link = "#" }) => {
