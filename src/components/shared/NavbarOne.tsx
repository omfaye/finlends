...
const NavbarOne = () => {
  ...
  return (
    <header
      className={
        bgColor
          ? "header-section index header-animation "
              ...
              >
                <div className="main-menu index-page">
                  <div className="navbar-nav mb-lg-0 mx-auto">
                    {navMenus.map(({ id, name, submenus, url, isSubmenu }) => {
                  ...
                  <div className="nav-right d-none d-xl-block" ref={refOne}>
                    <div className="nav-right__search">
                      <button onClick={handleSearch} className="bg-transparent">
                        <SearchButton icon={<i className="bi bi-search"></i>} />
                      </button>
                      <Link href="/sign_in">
                        <PrimaryButton
                          text="Sign In"
                    ...
                    >
                      <div className="nav-search-inner__form">
                        <form method="POST" id="search" className="inner__form">
          ...
          <div className="row">
            <div className="custom-nevbar__left">
              ...
              <div className="custom-nevbar__nav mb-lg-0 my-4 ">
                {navMenus.map(({ id, name, submenus, url, isSubmenu }, idx) => {
                  const isActive = submenus?.some((p) => path === p.url);
                  return (
                    <div key={id} className="menu_item dropdown mt-2 ">
                      {isSubmenu ? (
                        ...
                        <div className="menu_item" data-bs-dismiss="offcanvas">
                          <Link
                            aria-label="Close"
